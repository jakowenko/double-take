...
let constants = {
  ...
  CONFIDENCE_UNKNOWN: CONFIDENCE_UNKNOWN ? parseInt(CONFIDENCE_UNKNOWN, 10) : 40,
  SAVE_UNKNOWN: SAVE_UNKNOWN === 'true',
  PURGE_UNKNOWN: PURGE_UNKNOWN ? parseFloat(PURGE_UNKNOWN) : 48,
  PURGE_MATCHES: PURGE_MATCHES ? parseFloat(PURGE_MATCHES) : 48,
